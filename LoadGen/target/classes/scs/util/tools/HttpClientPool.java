...
public class HttpClientPool {
	...
	public static void main(String args[]) throws ClientProtocolException, IOException{
		...
		String parmStr="{\"signature_name\": \"serving_default\", \"instances\":[{\"myInput\":["+builder.toString()+"]}]}";
		*/
		...
		builder.append(random.nextDouble());
		String parmStr="{\"signature_name\": \"serving_default\", \"instances\":[{\"x\":["+builder.toString()+"]}]}";
		
		

		
		//System.out.println(HttpClientPool.getInstance().send("http://192.168.3.130:9501/v1/models/mnist:predict","{\"signature_name\": \"serving_default\", \"instances\":[{\"myInput\":["+builder.toString()+"]}]}"));
	}
